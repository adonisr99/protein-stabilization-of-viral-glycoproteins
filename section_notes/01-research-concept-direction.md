...
**Research Philosophy**: Following the Computer Science-inspired methodology of assumption + hypothesis, we identify literature-level assumptions that span multiple papers and propose inversions that could reshape the entire field of viral glycoprotein vaccine design.
...
### Assumption 5: Thermal Stability as Primary Metric

**What the field assumes**: Thermal stability (melting temperature) is the most relevant metric for evaluating stabilization success and predicting vaccine performance.

**Why this may be limiting**: Thermal stability may not correlate with functional stability under physiological conditions, storage stability, or immunological presentation quality.

### Assumption 6: Post-Fusion State Avoidance

**What the field assumes**: Any transition toward post-fusion conformations is detrimental and should be completely eliminated through stabilization.

**Why this may be limiting**: Controlled exposure of post-fusion epitopes might enhance breadth of immune response and provide protection against escape variants.

### Assumption 7: Structure-Based Design Sufficiency

**What the field assumes**: High-resolution structural information provides sufficient guidance for rational stabilization design without requiring extensive experimental screening.
...
### Hypothesis 5: Functional Stability Over Thermal Stability

**Prior work assumes**: Thermal stability is the best predictor of vaccine antigen performance
**We propose**: Functional stability metrics (receptor binding retention, conformational integrity under physiological stress) better predict immunogenic success
**This matters because**: It could redirect stabilization efforts toward clinically relevant stability measures and improve vaccine efficacy predictions

### Hypothesis 6: Strategic Post-Fusion Exposure

**Prior work assumes**: Any post-fusion conformation exposure reduces vaccine effectiveness
**We propose**: Controlled, limited exposure of conserved post-fusion epitopes enhances breadth of immune response
**This matters because**: It could provide broader protection against variant escape and improve universal vaccine design

### Hypothesis 7: Dynamics-Informed Rational Design

**Prior work assumes**: Static high-resolution structures provide sufficient information for optimal stabilization design
...
**Assumption Validation**: Evidence that challenges at least 3 identified literature assumptions
